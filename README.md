> [!WARNING]
> core components (like niri and waybar) SHOULD work as intended, however some smaller pieces - such as `waybar-mpris` and a lot of its few helper scripts - are currently broken
